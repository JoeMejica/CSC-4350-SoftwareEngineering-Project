...
public class Admin extends Employee{
	public Admin(String firstName, char middleInitial,String lastName, 
	...
	public Employee addEmployee(String firstName, char middleInitial,String lastName, 
			String username, String PhoneNumber, String Email, 
			String emergencyContactName,String emergencyNumber, String emergencyEmail){
		return new Employee(firstName, middleInitial, lastName, username, PhoneNumber, Email, 
			 emergencyContactName, emergencyNumber, emergencyEmail);
	}
